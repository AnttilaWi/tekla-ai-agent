...
\- \*\*Find and select objects\*\* by name, position mark, profile, material, structural class, or elevation — and chain that straight into the other tools. Ask for "all columns with class 201 between elevation 3000–6000mm" and get their total weight in one sentence; no manual clicking required.
