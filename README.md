...
A conversational AI agent for **Tekla Structures**, built with Microsoft's brand-new **Agent Framework** and **Azure OpenAI**. It lets a structural engineer ask questions and issue commands in plain language — "select all columns on floor 2 and total their weight" — instead of clicking through menus.

## Why this exists

I'm a structural engineer transitioning into software/digitalization roles. Rather than building a generic AI demo, I wanted to prove I can bridge both worlds: understand what's actually useful on a real jobsite, and build the software to deliver it — including debugging genuinely hard integration problems along the way (see *Notes from the build* below).
...
- **Find and select objects** by name, position mark, profile, material, structural class, or elevation — and chain that straight into the other tools. Ask for "all columns with class 2 between elevation 3000–6000mm" and get their total weight in one sentence; no manual clicking required.
